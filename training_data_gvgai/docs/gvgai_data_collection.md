...
Use a different port if one is already occupied. The default world-model catalog covers the games and variants described in the Variant Catalog section above. Example:
