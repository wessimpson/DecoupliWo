...
public class GVGAIBridge {
    ...
    private void applyAction(Types.ACTIONS action) {
    ...
    public void step(String actionName) {
        applyAction(Types.ACTIONS.fromString(actionName));
    }

    /**
     * Advances the game by one step using sampleMCTS (UCT) within a CPU-time budget.
     *
