    ...
    private String[] effectStrings = new String[]
            {
                    ...
                    "pullWithIt", "wallStop", "collectResource", "collectResourceIfHeld", "killIfOtherHasMore",
                    "killIfFromAbove", "killIfFromBelow", "killIfFromRight",
    ...
    private Class[] effectClasses = new Class[]
            {
                    ...
                    PullWithIt.class, WallStop.class, CollectResource.class, CollectResourceIfHeld.class, KillIfOtherHasMore.class,
                    KillIfFromAbove.class, KillIfFromBelow.class, KillIfFromRight.class,
