...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Playable single-player custom Pong demo.")
...
def _require_pygame():
    try:
        ...
        raise SystemExit("pygame is required for the playable demo. Install it with `pip install pygame`.") from exc
    return pygame


def build_env(args: argparse.Namespace, mode: str) -> PongEnv:
    return PongEnv(
        width=args.width,
        height=args.height,
        mode=mode,
